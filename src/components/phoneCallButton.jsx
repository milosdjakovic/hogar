...
const PhoneCallButton = ({ phoneNumber }) => {
  ...
  return (
    <div id="call-fixed-button" className="fixed bottom-0 left-0 z-10 flex grid items-center grid-cols-2 grid-rows-1 mb-4 ml-4 rounded-full md:hidden">      
      <a
        id="call-action"
      ...
      <div ref={infoText} id="call-fixed-button-info-text" className="z-10 flex items-center h-12 col-start-1 col-end-3 row-start-1 row-end-2 pl-12 text-gray-100">
        ...
        <p className="ml-2 mr-6 text-lg">Poruči i pokupi</p>
      </div>

      <div ref={infoWrapper} id="call-fixed-button-info-wrapper" className="z-0 h-12 col-start-1 col-end-3 row-start-1 row-end-2 pl-12 bg-gray-800 bg-opacity-75 rounded-full" style={{ backdropFilter: 'blur(4px)', WebkitBackdropFilter: 'blur(4px)'}} />
    </div>
  )
}
