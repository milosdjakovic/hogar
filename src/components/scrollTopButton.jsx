...
const ScrollTopButton = ({ windowOnTop }) => {
  ...
  return (
    <button
      ...
      className="fixed bottom-0 right-0 z-10 flex items-center justify-center w-12 h-12 mb-4 mr-4 bg-white bg-orange-200 rounded-full shadow-lg hover:text-gray-100 hover:bg-orange-500 focus:outline-none"
      onClick={scrollView}
